...
<div class="container">
    <div class="row">
        ...
        <form class="col-6" action="/customer/createOrUpdate" method="post" enctype="multipart/form-data">

            <div class="input-group mb-3 input-group-sm">
                <span class="input-group-text" >ID</span>
                <input name="id" value="${customer.id}" type="text" class="form-control" readonly>
            </div>
            ...
            <div class="input-group mb-3 input-group-sm">
                ...
                <input name="age" value="${customer.age}" type="number" class="form-control">
            </div>
...
<%--                Hai nut button nao cung dc--%>
                <button formaction="/customer/createOrUpdate"  class="btn btn-success">Create</button>
